...
describe SubmissionsController do
  ...
  let(:valid_attributes) { { "receipt" => "MyText" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved submission as @submission" do
        ...
        post :create, {:submission => { "receipt" => "invalid value" }}, valid_session
        assigns(:submission).should be_a_new(Submission)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested submission" do
        ...
        Submission.any_instance.should_receive(:update).with({ "receipt" => "MyText" })
        put :update, {:id => submission.to_param, :submission => { "receipt" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the submission as @submission" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Submission.any_instance.stub(:save).and_return(false)
        put :update, {:id => submission.to_param, :submission => { "receipt" => "invalid value" }}, valid_session
        assigns(:submission).should eq(submission)
      end
